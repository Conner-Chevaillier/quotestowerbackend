...
module.exports = {
   ...
   postNewSavedQuote(body) {
      ...
      let faveArr = return db('users').where('email', body.userId).returning('faveIDs')
      console.log('fave arr is ', faveArr)
      return db('users').where('email', body.userid).insert('faveIDs', body.quoteId).returning('faveIDs')
   }
